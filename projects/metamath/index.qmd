...
This document can be a starting place for summarizing what the MetaMath project is about.
...
Our primary goal is to promote JAIDE (Justice, Access, Inclusion, Diversity, Equity) in Mathematics by uncovering, documenting, and highlighting inequities. We intend to do this by:
...
* To demonstrate by example that the mathematical sciences can be used to promote social justice and have quantifiable real-word (positive) impacts.
